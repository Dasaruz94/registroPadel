            ...
            <div id="content" class="article-v1">
                <div class="panel box-shadow-none content-header">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <h3 class="animated fadeInLeft">Encuentro</h3>
                    ...
                    <div class="col-md-12 panel">
                        ...
                        <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                            <div class="col-md-12">
                                ...
                                $tablaDeMysql = "encuentro"; //Define el nombre de la tabla donde estan los datos


                                //Checamos si se lleno el campo de usuario en el formulario


                                $consulta = "SELECT * FROM ".$tablaDeMysql." WHERE id_encuentro LIKE '".$_GET['idE']."'";
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="col-sm-12 padding-0">
                                                    <select class="form-control" name="pareja1">
                                                        ...
                                                        while ($row = mysqli_fetch_row($resultado)) {
                                                            ?>
                                                            <option value="<?php echo $row[0]; ?>"><?php echo $row[4].'-'.$row[3]; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
